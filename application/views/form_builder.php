        ...
        <form action="process_form.php" method="post">
            ...
            <div id="form_fields">
                <div class="form-field">
                    ...
                    <div class="dynamic-input-group" id="dynamic-input-group" style="display: none;">
                        <label>Additional Input</label>
                        <div class="dynamic-input-container"></div>
                    </div>

                    <div class="form-group" id="size-length-group">
            ...
            <button type="button" id="add_field" class="btn btn-primary">Add More</button><br>
